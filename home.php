                ...
                <div class="col col-sm-12 col-md-5 col-lg-5">
                    <form action="includes/login_check.php" method="POST">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"
                                id="email" name="content" type="text" aria-describedby="emailHelp"
                                placeholder="Ask for Recommendations."></textarea>
                            </div>
                            
                            <div class="form-group" style="display:inline;"><input class="form-control"
                                id="email" name="location" type="text" 
                                placeholder="Location" style="width:30%;display:inline-block;"></div>
                            
                            <div class="form-group" style="display:inline;" ><input class="form-control"
                            id="email" name="location" type="text"
                            placeholder="Category" style="width:55%;display:inline-block;"></div>

                        
                        <div class="form-group float-right"><button class="btn btn btn-outline-primary"
                                type="submit"><span class="mbri-success"></span> Post</button></div><br>
                    </form>
                    ...
                    <div class="col col-sm-12 col-md-12 col-lg-12 mt-5">
                        ...
                        <div class="box">
                            ...
                            <div class="form-group" style="display:inline;"><input class="form-control"
                                id="email" name="location" type="text" 
                                placeholder="Location" style="width:90%;display:inline-block;"></div>
                                <div class="form-group float-right"><button class="btn btn btn-outline-primary"
                                type="submit"><span class="mbri-success"></span> Post</button></div>
